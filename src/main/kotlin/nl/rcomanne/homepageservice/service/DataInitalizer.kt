...
class DataInitalizer(
    ...
    fun generateEducations() {
        ...
        educations.add(Education(
                title = "Archeology Master (WO)",
                school = "University of Amsterdam",
                description = "Started with an Archeology study in Amsterdam, but was not what I expected of it, stopped after a few months.",
        ...
        educations.add(Education(
                title = "Law Master (WO)",
                school = "University of Amsterdam",
                description = "Started with an Law study in Amsterdam, but at the end of the year, I had 40 of the 45 required points to continue.",
    ...
    fun generateSkills() {
        ...
        skills.add(Skill(
                ...
                type = SkillType.PROGRAMMING_LANGUAGE,
                progress = 50,
                description = "I've gained some experience in Groovy due to working with Jenkins and a custom pipeline library for it, as this is all done in Groovy code. However, I do not have extensive knowledge of the language."
        ))
        ...
        skills.add(Skill(
                ...
                type = SkillType.PROGRAMMING_LANGUAGE,
                progress = 70,
                description = "In creating and automating our infrastructure and CI/CD, I've picked up quite a bit of experience in working with Bash."
        ))
        ...
        skills.add(Skill(
                ...
                type = SkillType.PROGRAMMING_LANGUAGE,
                progress = 30,
                description = "I have some experience with GoLang, mostly from my study, where we created simple CLI apps, but also a custom web server for file sharing.\nThe language is quite nice to work in, however, I do miss some of the features of Java like a proper class structure."
        ))
        ...
        skills.add(Skill(
                ...
                progress = 70,
                description = "I've been working with Docker for quite a while now, creating base images, setting up builds for applications etc."
        ))
        ...
        skills.add(Skill(
                ...
                type = SkillType.TOOLING,
                progress = 60,
                description = "We have setup and are running our kubernetes clusters in Azure with AKS, but I've also got my own cluster running on a few VPSes."
        ))
        ...
        skills.add(Skill(
                ...
                type = SkillType.CI_CD,
                progress = 75,
                description = "I've invested quite a bit of time in setting up our projects and creating templates for teams to use, allowing me to learn a lot of the details of this tool."
        ))
    ...
    fun generateWorkExperiences() {
        ...
        workExperiences.add(WorkExperience(
                ...
                company = "Rabobank",
                description = "As a DevOps Engineer for Rabobank I've been responsible for a lot of different tasks. What started as Java application development, turned into designing, creating and managing infrastructure for the developers.\nCurrently I work a lot on our Azure DevOps CI/CD system, our Kubernetes environment and everything else we have running on Azure.",
        ...
        workExperiences.add(WorkExperience(
                ...
                company = "Ordina",
                description = "Started with a Java Traineeship at Ordina. After a couple of months of internal training, I was placed at Rabobank to work at the Mortgages department.\nDuring this time, I worked on a big monolithic Java application.",
        ...
        workExperiences.add(WorkExperience(
                ...
                description = "Worked at SiSo computers on projects where we installed work places at companies while in between studies.",
